...
description: The security and privacy review lens for code changes. Covers secrets/env vars, the framework's public/client-exposed env-var prefix, input validation, public exposure, output-encoding/injection in rendered content, SSRF/outbound fetching, error-reporting data capture, and dependency/supply-chain risk.
